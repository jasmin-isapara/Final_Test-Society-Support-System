...
<div class="jumbotron rounded-0 clearfix w-100 m-0 about" id="about" >
    ...
    <div class="col-lg-4 col-md-12 float-lg-right">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQo46GgqAT7uV_kAfb0_Qx3sdLNT-p3N5zLiXsTfsLb6Q&s" class="img-fluid rounded" alt="image">
    </div>
...
<div class="jumbotron rounded-0 clearfix w-100 m-0 about" id="about" >
    <div class="col-lg-4 col-md-12 float-lg-left">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT1IFJnP6MUmSaqqNSZypiXwK11O9Ey6DSdRRo-O_BqRw&s" class="img-fluid rounded" alt="image">
    </div>
    <div class="col-lg-8 col-md-12 float-lg-right">
        <p class="lead text-justify">Lorem Ipsum is simply dummy text of the printing and typesetting industry.
            Lorem Ipsum has been the industry's standard dummy text ever since the
